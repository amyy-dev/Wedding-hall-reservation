...
<body dir="rtl">
    ...
    <section class="home" id="home">
        ...
        <div class="swiper home-slider">
            ...
            <div class="swiper-slide"><img src="img/1.jpg" alt=""> </div>
                ...
                <div class="swiper-slide"><img src="img/12.jpg" alt=""> </div>
                <div class="swiper-slide"><img src="img/13.jpg" alt=""> </div>
                <div class="swiper-slide"><img src="img/14.jpg" alt=""> </div>
                <div class="swiper-slide"><img src="img/15.jpg" alt=""> </div>
                <div class="swiper-slide"><img src="img/16.jpg" alt=""> </div>
                <div class="swiper-slide"><img src="img/17.jpg" alt=""> </div>
            </div>
        </div>
    ...
    <section class="footer">
        ...
        <div class="credit">تم الانشاء من طرف  <span> amy-dev   </span> جميع الحقوق محفوظة</div>
    </section>
    ...
    <div  class="theme-toggler"> 
        ...
        <div class="buttons">
            ...
            <div class="theme-btn" style="background-color: #df8dd8;"></div>
            <div class="theme-btn" style="background-color: #CEA2AB;"></div>
            <div class="theme-btn" style="background-color: #916373;"></div>
            <div class="theme-btn" style="background-color: #7b4a77;"></div>
            <div class="theme-btn" style="background-color: #e47f8f;"></div>
